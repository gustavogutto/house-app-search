...
/**
 * MyHome.ie alert emails haven't been sampled yet — this delegates to the
 ...
 */
export function parseMyHome(html: string): ParseResult {
  return parseGeneric(html, "myhome");
}
